...
public class ShopItemSpawner : MonoBehaviour
{
    ...
    [Tooltip("The probablity of dropping Tier D loot.")]
    public int m_tierDProbability;

    [Tooltip("The probablity of dropping Tier C loot.")]
    public int m_tierCProbability;

    [Tooltip("The probablity of dropping Tier B loot.")]
    public int m_tierBProbability;

    [Tooltip("The probablity of dropping Tier A loot.")]
    public int m_tierAProbability;

    [Tooltip("The probablity of dropping Tier S loot.")]
    public int m_tierSProbability;

    //An array of integers representing the loot table
    private int[] m_lootTable;

    //The combined value of all tier probabilities
    ...
    //The weapon tier generated by the random loot generator
    private weaponTier m_generatedWeaponTier;

    [Tooltip("An array of D tier weapons.")]
    public GameObject[] m_tierDWeapons;

    [Tooltip("An array of C tier weapons.")]
    public GameObject[] m_tierCWeapons;
    
    [Tooltip("An array of B tier weapons.")]
    public GameObject[] m_tierBWeapons;
    
    [Tooltip("An array of A tier weapons.")]
    public GameObject[] m_tierAWeapons;
    
    [Tooltip("An array of S tier weapons.")]
    public GameObject[] m_tierSWeapons;

    //The prefab of the chosen weapon
    private GameObject m_purchasableWeaponPrefab;

    [Tooltip("The transform position at which the generated weapon is instantiated.")]
