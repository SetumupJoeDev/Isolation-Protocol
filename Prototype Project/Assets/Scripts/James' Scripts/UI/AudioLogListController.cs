...
public class AudioLogListController : MonoBehaviour
{
    ...
    [Tooltip("An array containing the Scriptable Objects that hold the data for the audiologs.")]
    public AudioLogScriptableObject[] m_audioLogs;

    [Tooltip("The list of buttons generated by this script.")]
    public List<GameObject> m_audioLogButtons;

    [Tooltip("The template button that all new buttons are based on.")]
    public GameObject m_buttonTemplate;

    [Tooltip("The number of audiologs the player currently has unlocked.")]
    ...
    {
        //Loops through the list of buttons and sets a button as active for each unlocked audiolog
